...
import { type ParsedDataLayer, generateSelectorCombinations } from './layer_parser.ts'
 ...
 * @returns {string}
 */
export let findBrowserExecutable = function () {
 ...
 */
export let getTimelapseJobStatus = function (arg0_job_id: string) {
 ...
 * @returns {boolean}
 */
export let cancelTimelapseJob = function (arg0_job_id: string) {
  //Convert from parameters
  let job_id = arg0_job_id
 ...
 */
export let expandLayersToCyclingTargets = function (
 ...
 */
export let startTimelapseRenderJob = async function (
