...
export let Card = React.forwardRef<
  HTMLDivElement,
...
export let CardHeader = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(function (arg0_props, arg1_ref) {
  //Convert from parameters
...
export let CardTitle = React.forwardRef<
  HTMLHeadingElement,
...
export let CardDescription = React.forwardRef<
...
export let CardContent = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(function (arg0_props, arg1_ref) {
  //Convert from parameters
...
export let CardFooter = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(function (arg0_props, arg1_ref) {
  //Convert from parameters
