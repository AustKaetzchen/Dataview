...
import { transformValue, createPercentileRankCalculator } from '@framework/geopng/scales'
 ...
 * @returns {Object}
 */
export let useElevationSpikes = function (arg0_options: UseElevationSpikesParams): { points: ElevationSpikePoint[] } {
