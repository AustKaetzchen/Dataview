import { CountryFeature, findCountryAtLngLat, isPointInGeometry } from './polygon_binning.ts'
import { invertEqualEarth } from './equal_earth.ts'
import { DecodedRaster, InspectionData, ProjectionType } from './types.ts'
 ...
 */
export let sampleRasterAt = function (
  arg0_coord_x: number,
  arg1_coord_y: number,
