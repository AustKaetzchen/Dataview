 ...
 */
export const loadCityCache = function (): Record<string, CityCacheRecord> {
 ...
 */
export const loadGhslCsvNames = function (): Map<string, string> {
  //Declare local instance variables
  let csv_path: string
  let lines: string[]
  let raw_text: string
 ...
 */
export const saveCityCache = function (): void {
  //Declare local instance variables
 ...
 */
export const clearStadesterDiskCache = function (): void {
  //Declare local instance variables
 ...
 */
export const indexHistoricalCities = function (arg0_raw_data: Record<string, any>): void {
 ...
 * @returns {string | null}
 */
export const findClosestHistoricalCity = function (
 ...
 */
export const queuePhotonLookup = function (
  arg0_key: string,
 ...
 * @returns {string}
 */
export const resolveCityDisplayName = function (
  arg0_key: string,
