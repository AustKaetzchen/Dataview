...
import { HistoricalBordersConfig } from '@/lib/geopng/types'
 ...
 */
export const HistoricalBordersSettings: React.FC<HistoricalBordersSettingsProps> = function (arg0_props) {
