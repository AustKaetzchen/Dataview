...
import { getDefaultExportZoom } from './videoExportUtils'
import type { TimestepUnit, VideoExportMode } from './videoExportUtils'
 ...
 */
export const VideoExportSettingsForm: React.FC<VideoExportSettingsFormProps> = function (arg0_props) {
